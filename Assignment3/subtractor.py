...
def get_frames(path, bg_path):
    ...
    while True:
        ...
        if i > 119:
            cv2.imwrite("foreground/cam1/" + str(i - 120) + ".png", mask)
            cv2.imwrite("videoframe/cam1/" + str(i - 120) + ".png", frame)

        i = i + 1


get_frames("4persons/video/cam1.avi", "4persons/background/cam1.avi")
