...
def threshold(hsv):
    ...
    cv2.imwrite("step1\Diff\cam4\diff\Diff_threshold.png", result)
    cv2.destroyAllWindows()
    return result


Diff_H = 'step1\Diff\cam4\diff\Diff_H.png'
Diff_S = 'step1\Diff\cam4\diff\Diff_S.png'
Diff_V = 'step1\Diff\cam4\diff\Diff_V.png'
